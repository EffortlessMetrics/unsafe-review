pub fn copy_byte_to_bool_closed_if_observed(value: u8) -> bool {
...
#[cfg(test)]
mod tests {
    use super::copy_byte_to_bool_closed_if_observed;

    #[test]
    fn mentions_copy_byte_to_bool_closed_if_observed() {
        let _ = stringify!(copy_byte_to_bool_closed_if_observed);
    }
}
