...
|---|---|---|
| Dogfood has a manifest-backed corpus of selected real crates and PR diffs | `dogfood/corpus.toml` is validated by `cargo xtask check-dogfood`; current `check-pr` reports 23 targets across 5 repositories | Done |
