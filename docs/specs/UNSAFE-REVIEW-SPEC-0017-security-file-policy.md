# UNSAFE-REVIEW-SPEC-0017: Security and file policy
...
`unsafe-review` needs a precise, checkable behavior contract for security and file policy.

## Behavior

Rust by default, non-Rust by receipt, risky behavior by companion policy, CI enforcement through receipts.
