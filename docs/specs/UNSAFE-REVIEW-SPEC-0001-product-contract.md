# UNSAFE-REVIEW-SPEC-0001: Product contract
...
`unsafe-review` needs a precise, checkable behavior contract for product contract.

## Behavior

The tool must report static unsafe review evidence, not memory-safety proof. It must emit changed-seam review cards with trust-boundary wording.
