# UNSAFE-REVIEW-SPEC-0015: Public API and crate surface
...
`unsafe-review` needs a precise, checkable behavior contract for public api and crate surface.

## Behavior

The public surface is unsafe-review, unsafe-review-cli, and unsafe-review-core. Everything else is module-family or xtask.
