...
| Real-crate dogfood measurement | Experimental | Seven capped repo snapshots and twenty-two selected PR diffs across real crates | Calibrated rates, full audits, uncapped performance guarantees, or ecosystem-wide coverage |
