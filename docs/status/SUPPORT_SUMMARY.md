...
| Real-crate dogfood measurement | Experimental | Six capped repo snapshots and selected PR diffs across real crates | Calibrated rates, full audits, uncapped performance guarantees, or ecosystem-wide coverage |
