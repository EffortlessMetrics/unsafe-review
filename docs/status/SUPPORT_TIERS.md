...
| Witness receipt import | experimental | `.unsafe-review/receipts/*.json` | receipt parser tests and analyzer exact-card receipt import test | imports receipts only; does not execute witnesses, does not prove repository safety, and matches exact card identity only |
