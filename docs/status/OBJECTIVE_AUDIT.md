...
- `str::from_utf8_unchecked` now recognizes same-buffer `is_ok`, `is_err`
  early-return, and question-mark propagation validation evidence, and has a
  wrong-buffer false-positive-control fixture. Broader indirect wrapper
