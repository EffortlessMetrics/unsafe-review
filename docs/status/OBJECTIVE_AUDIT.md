...
- The `hashbrown#469` `unreachable_unchecked` sites are labeled as
  invalid-value operation cards, but unreachable-path proof inference remains
  future work.
