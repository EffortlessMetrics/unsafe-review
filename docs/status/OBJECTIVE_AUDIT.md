...
- Broader calibration on real unsafe-heavy crates is still needed before any
  ...
  seven top-50 capped repo snapshots and twenty-one PR diffs across seven crates;
