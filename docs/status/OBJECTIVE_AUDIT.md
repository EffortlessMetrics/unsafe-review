...
- Broader calibration on real unsafe-heavy crates is still needed before any
  ...
  seven top-50 capped repo snapshots and nineteen PR diffs across seven crates;
