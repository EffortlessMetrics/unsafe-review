...
- Broader calibration on real unsafe-heavy crates is still needed before any
  ...
  four top-50 capped repo snapshots and seventeen PR diffs across four crates;
